---
title: Run an Autohealing Elixir Cluster on Google Kubernetes Engine
description: Learn how to deploy any Elixir app, clustered via Kubernetes API, so the nodes always know which containers to connect to.
author: zeroasterisk
...
[Elixir](http://elixir-lang.org/) cluster on any 
[Kubernetes](https://kubernetes.io) installation.  
In this guide, I am using
[Google's Kubernetes Engine](https://cloud.google.com/kubernetes-engine/),
for simple and stable container-based deployment.
...
This tutorial requires Elixir 1.4 or later. It assumes you are
already somewhat familiar with basic Elixir development. For simplicity, the
tutorial app does not use Phoneix, Ecto or connect to a database, but you can extend
...
Your Elixir clustered app can be a group of
[Phoenix](http://phoenixframework.org/) Web Servers
or a custom 
[OTP Server](https://elixir-lang.org/getting-started/mix-otp/supervisor-and-application.html)
or any other
...
Create a project that will host your Elixir application. You can also reuse
an existing project.
...
* might as well do a super simple webserver for easy viewing, but we don't want to distract... 
* needs to connect to other nodes and display a list of all connected nodes
